...
sys.path.append('/home/kosala/git-repos/physical_activity_routine_creation_module/hexagonal-flask-app/app/adapters/rest/flask_server/')
import connexion
